 ...
 * </pre>
 */
public class ExampleEapearsonSanityCheckServer extends JsonServerServlet {
    ...
    public ExampleEapearsonSanityCheckServer() throws Exception {
        super("example_eapearson_SanityCheck");
        //BEGIN_CONSTRUCTOR
     ...
     */
    @JsonServerMethod(rpc = "example_eapearson_SanityCheck.filter_contigs", async=true)
    ...
    @JsonServerMethod(rpc = "example_eapearson_SanityCheck.status")
    ...
    public static void main(String[] args) throws Exception {
        if (args.length == 1) {
            new ExampleEapearsonSanityCheckServer().startupServer(Integer.parseInt(args[0]));
        } else if (args.length == 3) {
            JsonServerSyslog.setStaticUseSyslog(false);
            JsonServerSyslog.setStaticMlogFile(args[1] + ".log");
            new ExampleEapearsonSanityCheckServer().processRpcCall(new File(args[0]), new File(args[1]), args[2]);
        } else {
