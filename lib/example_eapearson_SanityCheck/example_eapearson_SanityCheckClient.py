...
class example_eapearson_SanityCheck(object):
    ...
    def filter_contigs(self, params, context=None):
        ...
        return self._client.call_method(
            'example_eapearson_SanityCheck.filter_contigs',
            [params], self._service_ver, context)

    def status(self, context=None):
        return self._client.call_method('example_eapearson_SanityCheck.status',
