package exampleeapearsonsanitycheck.test;
...
import exampleeapearsonsanitycheck.FilterContigsParams;
import exampleeapearsonsanitycheck.FilterContigsResults;
import exampleeapearsonsanitycheck.ExampleEapearsonSanityCheckServer;
...
public class ExampleEapearsonSanityCheckServerTest {
    private static AuthToken token = null;
    private static Map<String, String> config = null;
    private static WorkspaceClient wsClient = null;
    private static String wsName = null;
    private static ExampleEapearsonSanityCheckServer impl = null;
    ...
    public static void init() throws Exception {
        ...
        config = ini.get("example_eapearson_SanityCheck");
        // Token validation
        ...
        JsonServerSyslog.setStaticMlogFile(new File(config.get("scratch"), "test.log")
            .getAbsolutePath());
        impl = new ExampleEapearsonSanityCheckServer();
    }
    
    private static String getWsName() throws Exception {
        if (wsName == null) {
            long suffix = System.currentTimeMillis();
            wsName = "test_ExampleEapearsonSanityCheck_" + suffix;
    ...
    private static RpcContext getContext() {
        return new RpcContext().withProvenance(Arrays.asList(new ProvenanceAction()
            .withService("example_eapearson_SanityCheck").withMethod("please_never_use_it_in_production")
