SERVICE = example_eapearson_sanitycheck
SERVICE_CAPS = example_eapearson_SanityCheck
SPEC_FILE = example_eapearson_SanityCheck.spec
URL = https://kbase.us/services/example_eapearson_sanitycheck
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
